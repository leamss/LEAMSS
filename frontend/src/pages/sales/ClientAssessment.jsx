    ...
    <div className="min-h-screen bg-slate-50 p-5" data-testid="client-assessment-page">
      <div className="max-w-6xl mx-auto space-y-4">
        ...
        <Card className="p-5 min-h-[400px]" data-testid={`step-${step}-content`}>
          ...
          {step === 7 && <Step7Done saved={saved} createPA={createPA} navigate={navigate} />}
        </Card>
...
// Step 7: Done — Actions
// ════════════════════════════════════════════════════════════════
function Step7Done({ saved, createPA, navigate }) {
  return (
    <div className="max-w-2xl mx-auto text-center space-y-4 py-6" data-testid="step-7-done">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-6">
        <Button size="lg" className="bg-indigo-600 hover:bg-indigo-700" onClick={createPA} data-testid="create-pa-btn">
          <ArrowRight className="h-4 w-4 mr-1" />Create Pre-Assessment
        </Button>
        <Button size="lg" variant="outline" onClick={() => navigate(`/sales/occupations`)} data-testid="back-to-search">
          <Search className="h-4 w-4 mr-1" />Back to Search
        </Button>
        <Button size="lg" variant="outline" onClick={() => window.print()} data-testid="export-pdf">
