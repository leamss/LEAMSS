          ...
          {generating ? (
            ...
            <>
              ...
              <Card className="p-3 border-0 shadow-lg bg-white sticky bottom-4">
                <div className="flex items-center gap-2">
                  <Button onClick={handleSave} disabled={saving} className="flex-1 bg-[#2a777a] hover:bg-[#236466]" data-testid="save-btn">
                    {saving ? <Loader2 className="h-4 w-4 mr-2 animate-spin" /> : <Save className="h-4 w-4 mr-2" />}Save as Product
                  </Button>
