...
import { Plus, Edit2, Trash2, RefreshCw, Calculator, X, Save } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" data-testid="fee-policy-modal">
      <Card className="w-full max-w-lg p-5">
        ...
        <div className="flex justify-end gap-2 mt-4 pt-3 border-t">
          ...
          <Button onClick={save} disabled={saving || !form.policy_name} className="bg-leamss-teal hover:bg-leamss-teal/90" data-testid="modal-save-btn">
            <Save className="h-3.5 w-3.5 mr-1" />{isEdit ? 'Update' : 'Create'}
          </Button>
        </div>
      </Card>
    </div>
