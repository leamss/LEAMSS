    ...
    <div className="grid grid-cols-12 gap-2 items-center py-2 border-b last:border-b-0 text-sm" data-testid={`alloc-row-${allocation.allocation_id}`}>
      <div className="col-span-3">
        ...
        <p className="text-[11px] text-slate-500">
          ...
          {allocation.payment_type === 'percentage' && (
            <span className="ml-1 text-leamss-teal-700 font-semibold bg-leamss-teal-50 px-1 py-0.2 rounded border border-leamss-teal-200">
              {allocation.rate !== undefined && allocation.rate !== null ? allocation.rate : allocation.base_amount}%
            </span>
          )}
          {allocation.is_optional && ' · Optional'}
        </p>
      </div>
      <div className="col-span-3">
      ...
      <div className="col-span-2 text-right">
        <p className="text-sm font-bold text-slate-800">{formatINR(allocation.total_amount)}</p>
        {allocation.payment_type === 'percentage' && (
          <p className="text-[10px] text-slate-500 font-medium">
            {allocation.rate !== undefined && allocation.rate !== null ? allocation.rate : allocation.base_amount}% of revenue
          </p>
        )}
